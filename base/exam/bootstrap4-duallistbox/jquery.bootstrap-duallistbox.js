...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      moveSelectedLabel: '移动选定对象',
      moveAllLabel: '全部移动',
      removeSelectedLabel: '删除所选内容',
      removeAllLabel: '全部删除',
      ...
      infoText: '显示全部 {0} 个',                                                         // text when all options are visible / false for no info text
      infoTextFiltered: '从 {1} 中筛选出 {0} 个',                                          // when not all of the options are visible due to the filter
  ...
  function filter(dualListbox, selectIndex, moveToTop = true) {
    if (!dualListbox.settings.showFilterInputs) {
      return;
    }
